...
namespace Mygod.Edge.Tool
{
    static class Settings
    {
        static Settings()
        {
            ...
            CurrentPathData =
                new StringData(RecentPathsData = new StringListData(settingsFile, "RecentPaths"), "Current");
        }
        ...
        public static bool EdgeModLoaded
        {
            get { return EdgeModLoadedData.Get(); }
            set { EdgeModLoadedData.Set(value); }
        }

        public static List<string> RecentPaths
        {
            get { return RecentPathsData.Get(); }
            private set { RecentPathsData.Set(value); }
        }
